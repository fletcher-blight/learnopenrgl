...
fn main() -> anyhow::Result<()> {
    ...
    let mut fragment_function = FragmentFunction::Plain;
    ...
    'main: loop {
        ...
        for event in event_pump.poll_iter() {
            match event {
                ...
                sdl2::event::Event::KeyUp {
                    keycode: Some(sdl2::keyboard::Keycode::Num0),
                    ..
                } => fragment_function = FragmentFunction::Plain,
                sdl2::event::Event::KeyUp {
...

        {
            ...
            }
            {
                ...
                screen_shader_program
                    .set_uniform_i32("fragment_function", fragment_function.into());
...
impl From<FragmentFunction> for i32 {
    fn from(value: FragmentFunction) -> Self {
        match value {
